...
class App {
  ...
  onTouchUp(e) {
    ...
    if (Math.abs(this.start - x) < 10 && Date.now() - this.startTime < 500) {
...
export default function CircularGallery({
  ...
  useEffect(() => {
    const app = new App(containerRef.current, { items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, onItemClick, imageScale });
    return () => {
      app.destroy();
    };
  }, [items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, onItemClick, imageScale]);
